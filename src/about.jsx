            ...
            <section className="text-grey40 text-lg w-full mt-16 mb-8">
                ...
                <div className="w-full grid grid-cols-3 gap-x-6 mb-4">                   
                    ...
                    <div>
                        ...
                        */}
                        <p className="mt-8">Numpy, Pandas, Matplotlib, Seaborn, Tensorflow, Sk-learn, P
                            yTorch
                        </p>
                    </div>
                    {/*
            ...
            <section className="text-grey40 text-lg my-12 w-full">   
                ...
                <div className="grid grid-cols-2 gap-x-4">                                       
                    ...
                    <div>
                        ...
                        <ul className="my-8">
                            <li>Fav colour: <span className="text-yellow-300">yellow</span> <span className="text-purple60">purple</span> or some sorta <span className="text-grey20">dark grey</span> depending on mood</li> 
